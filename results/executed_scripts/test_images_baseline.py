"""Run YOLO11n on the two apartment photos."""
import csv
...
output_dir = project.parent / "step2" / "simple_results"
output_dir.mkdir(parents=True, exist_ok=True)
image_names = ["1P9A1048.JPG", "1P9A1049.JPG"]

# Load the same model used in main.py.
...
with (output_dir / "detections.csv").open("w", newline="", encoding="utf-8") as file:
    ...
    for image_name in image_names:
        ...
        # Detect objects with the original confidence threshold.
        result = model.predict(image, conf=0.5, imgsz=640, device="cpu")[0]
