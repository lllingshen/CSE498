...
DATA = STEP3 / "dataset" / "data.yaml"
OUTPUT = STEP3 / "comparison"
MODELS = {
    "before": PROJECT / "models" / "yolo11m.pt",
    "after": STEP3 / "training" / "weights" / "best.pt",
}
PHOTOS = [PROJECT.parent / "step2" / "inputs" / f"1P9A104{i}.JPG" for i in (8, 9)]
